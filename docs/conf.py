...
# -*- coding: utf-8 -*-
#
# pakages documentation build configuration file, created by
...
project = "Pakages"
copyright = "2021-2022, Vanessa Sochat and Alec Scott"
...
latex_documents = [
    (
        "index",
        "pakages.tex",
        "Pakages Documentation",
        "Vanessa Sochat and Alec Scott",
        "manual",
    ),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat", "Alec Scott"],
        "pakages",
        "Pakages is a framework for building community packages and containers.",
        "Miscellaneous",
    ),
]
...
def spack_clone(*args, **kwargs):
    ...
    if not os.path.exists(spack):
        os.system("git clone --depth 1 https://github.com/spack/spack %s" % spack)
    path = "%s/bin:%s" % (spack, os.environ["PATH"])
    os.putenv("PATH", path)
    os.environ["PATH"] = path
    from pakages.spack.utils import add_spack_to_path
